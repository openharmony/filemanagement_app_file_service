...
const bool BACKUP_DEBUG_OVERRIDE_EXTENSION_CONFIG_DEFAULT_VALUE = false;
...
const bool BACKUP_DEBUG_OVERRIDE_EXTENSION_BACKUP_SA_RELEASE_DEFAULT_VALUE = true;
...
const bool BACKUP_DEBUG_OVERRIDE_EXTENSION_INCREMENTAL_DEFAULT_VALUE = true;
