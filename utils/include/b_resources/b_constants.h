...
constexpr int LONG_FILE_NAME_BOUNDARY_VAL = 255;
constexpr int PATH_LEN_SAFE_THRESHOLD = 500;
...
// 应用的getBackupCompatibilityInfo/getRestoreCompatibilityInfo接口最大超时时间为1秒
constexpr int APP_GETCOMINFO_MAX_TIMEOUT = 1000;
...
static inline std::string_view PATH_ABSOLUTE_HOME_EL1 = "/data/app/el1/";
static inline std::string_view PATH_ABSOLUTE_HOME_EL2 = "/data/app/el2/";
...
static inline std::string GetBundleDir(int32_t userId, std::string bundleName, bool isEl2 = true)
{
    ...
    std::string str;
    str.append("/data/app/").append(el).append("/");
    str.append(std::to_string(userId));
    str.append("/base/");
...
static inline std::string BACKUP_VERSION = R"({"backupVersion" : "26.1"})";
