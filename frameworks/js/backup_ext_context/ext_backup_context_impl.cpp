...
extern const char _binary_backup_extension_context_abc_end[];
...
void NAPI_application_BackupExtensionContext_GetJSCode(const char **buf, int *bufLen)
{
    ...
    if (bufLen != nullptr) {
        *bufLen = _binary_backup_extension_context_js_end - _binary_backup_extension_context_js_start;
    }
}
...
void NAPI_application_BackupExtensionContext_GetABCCode(const char **buf, int *buflen)
{
    ...
    if (buflen != nullptr) {
        *buflen = _binary_backup_extension_context_abc_end - _binary_backup_extension_context_abc_start;
    }
}
