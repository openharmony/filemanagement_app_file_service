...
const std::string MEDIA_FILE_URI_PHOTO_PREFIX = "file://media/Photo/";
const std::string MEDIA_FILE_URI_AUDIO_PREFIX = "file://media/Audio/";
const std::string MEDIA_FILE_URI_VIDEO_PREFIX = "file://media/video/";
const std::string MEDIA_FILE_URI_IMAGE_PREFIX = "file://media/image/";
const std::string MEDIA_FILE_URI_FILE_PREFIX = "file://media/file/";
const std::string MEDIA_FILE_URI_AUDIO_PREFIX_L = "file://media/audio/";
