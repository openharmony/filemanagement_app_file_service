...
enum class IServiceInterfaceCode {
    ...
    SERVICE_CMD_INIT_RESTORE_SESSION_MSG,
    SERVICE_CMD_INIT_BACKUP_SESSION,
    SERVICE_CMD_INIT_BACKUP_SESSION_MSG,
    SERVICE_CMD_GET_LOCAL_CAPABILITIES,
    SERVICE_CMD_GET_LOCAL_CAPABILITIES_FOR_BUNDLE_INFOS,
    ...
    SERVICE_CMD_INIT_INCREMENTAL_BACKUP_SESSION_MSG,
