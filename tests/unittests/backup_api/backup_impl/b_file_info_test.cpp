 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0101, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0101";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0101";
}
 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0102, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0102";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0102";
}
 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0103, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0103";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0103";
}
 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0104, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0104";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0104";
}
 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0105, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0105";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0105";
}
 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0106, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0106";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0106";
}
 ...
 * @tc.require: I6F3GV
 */
HWTEST_F(BFileInfoTest, SUB_BFile_Info_Unmarshalling_0107, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BFileInfoTest-begin SUB_BFile_Info_Unmarshalling_0107";
    BFileInfo bFileInfo(BUNDLE_NAME, FILE_NAME, -1);
    Parcel parcel;
    // marshalling
    EXPECT_EQ(bFileInfo.Marshalling(parcel), true);
    ...
    auto infoPtr = bFileInfoTemp.Unmarshalling(parcel);
    EXPECT_NE(infoPtr, nullptr);
    GTEST_LOG_(INFO) << "BFileInfoTest-end SUB_BFile_Info_Unmarshalling_0107";
}
