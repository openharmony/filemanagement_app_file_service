...
HWTEST_F(BJsonUtilTest, b_jsonutil_ParseBundleNameIndexStr_0100, testing::ext::TestSize.Level0)
{
    GTEST_LOG_(INFO) << "BJsonUtilTest-begin b_dir_GetDirFiles_0104";
    try {
        ...
        std::vector<BJsonUtil::BundleDetailInfo> detailInfos = BJsonUtil::ConvertBundleDetailInfos(bundleNames, detailInfos, pattern,
