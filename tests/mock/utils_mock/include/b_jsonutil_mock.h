...
public:
    ...
    virtual std::string BuildInitSessionErrInfo(int32_t, std::string, std::string, std::string) = 0;
...
public:
    ...
    MOCK_METHOD(std::string, BuildInitSessionErrInfo, (int32_t, std::string, std::string, std::string));
