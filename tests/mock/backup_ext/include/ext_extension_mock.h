...
public:
    ...
    virtual ErrCode GetIncrementalFileHandles(const std::vector<std::string> &fileNames,
...
public:
    ...
    MOCK_METHOD(ErrCode, GetIncrementalFileHandles, (const std::vector<std::string> &, std::vector<FileOpenResult> &));
