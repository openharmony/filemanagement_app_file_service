...
{
    return OHOS::FileManagement::Backup::BAccessTokenKit::token->GetTokenType(tokenID);
}

int AccessTokenKit::GetHapTokenInfo(AccessTokenID callerToken, HapTokenInfo &hapTokenInfoRes)
{
    return OHOS::FileManagement::Backup::BAccessTokenKit::token->GetHapTokenInfo(callerToken, hapTokenInfoRes);
}
