...
public:
    ...
    MOCK_METHOD(ErrCode, BackupOnFileReadysWithoutFd,
                (const std::string &, const BStringRawData &, const std::vector<int32_t> &));
    MOCK_METHOD(ErrCode, BackupOnFileReadys,
                (const std::string &, const BStringRawData &, const std::vector<int> &, const std::vector<int32_t> &));
